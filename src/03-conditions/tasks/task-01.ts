/**
 * SMK Telkom Malang is preparing the graduation list for Grade 12 students. A student is eligible to graduate only 
...
const tuitionnPaid: boolean = true;

console.log("Student Name : ", studentName);
console.log("Final Score : ", finalScore);
console.log("Attendence : ", Attendance);
console.log("Tuition Paid : ", tuitionnPaid);

if (finalScore >= 75 && Attendance >= 90 && tuitionnPaid == true){
